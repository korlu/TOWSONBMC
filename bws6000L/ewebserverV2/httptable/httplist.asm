...
_DATA	SEGMENT
$SG2149	DB	'HTTPList:init:1 Insufficient space for allocating http r'
	DB	'ecords', 00H
	ORG $+1
$SG2152	DB	'HTTPList:init:1 Insufficient space for allocating http r'
...
; Line 155
	mov	DWORD PTR _i$2181[ebp], 0
	jmp	SHORT $L2182
$L2183:
	mov	edx, DWORD PTR _i$2181[ebp]
	add	edx, 1
	mov	DWORD PTR _i$2181[ebp], edx
$L2182:
	mov	eax, DWORD PTR _i$2181[ebp]
	cmp	eax, DWORD PTR _PkSize$[ebp]
	jge	SHORT $L2184
; Line 157
	mov	ecx, DWORD PTR _temp$[ebp]
	add	ecx, DWORD PTR _i$2181[ebp]
	mov	edx, DWORD PTR _HTTPData$[ebp]
	add	edx, DWORD PTR _i$2181[ebp]
	mov	al, BYTE PTR [edx]
	mov	BYTE PTR [ecx], al
; Line 158
	jmp	SHORT $L2183
...
; Line 222
	...
	mov	DWORD PTR _DataBuff$2207[ebp], ecx
; Line 223
	mov	DWORD PTR _i$2209[ebp], 0
	jmp	SHORT $L2210
$L2211:
	mov	edx, DWORD PTR _i$2209[ebp]
	add	edx, 1
	mov	DWORD PTR _i$2209[ebp], edx
$L2210:
	mov	eax, DWORD PTR _PkSize$[ebp]
	mov	ecx, DWORD PTR _i$2209[ebp]
	cmp	ecx, DWORD PTR [eax]
	jge	SHORT $L2212
; Line 225
	mov	edx, DWORD PTR _Data$[ebp]
	add	edx, DWORD PTR _i$2209[ebp]
	mov	eax, DWORD PTR _DataBuff$2207[ebp]
	add	eax, DWORD PTR _i$2209[ebp]
	mov	cl, BYTE PTR [eax]
	mov	BYTE PTR [edx], cl
; Line 226
	jmp	SHORT $L2211
