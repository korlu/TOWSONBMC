...
class apptask 
{
 ...
 public:
  ...
  static long TotalHttpCount;     //totoal no of HTTP requests  
  static long TotalRcvCount;     //totoal no of HTTP requests  
  static long TotalSuspendCount;     //totoal no of HTTP requests  
  ...
  static char SrcIP[4]; 
  static char FTPServerIP[4]; 
  static char GateWayIP[4]; 
  static char GateWayMAC[6]; 
