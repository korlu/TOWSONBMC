...
; Line 78
	mov	DWORD PTR _GDTIndex$1084[ebp], 30	; 0000001eH
; Line 79
	mov	eax, DWORD PTR _GDTIndex$1084[ebp]
	push	eax
	...
	mov	DWORD PTR _status$1085[ebp], eax
; Line 81
	jmp	$L1086
$L1081:
; Line 82
...
; Line 99
	mov	DWORD PTR _GDTIndex$1089[ebp], 30	; 0000001eH
; Line 100
	mov	edx, DWORD PTR _GDTIndex$1089[ebp]
	push	edx
	...
	add	ecx, 8
	call	?AOAsetGDTEntry@AOAProtected@@QAEHPAJ0H@Z ; AOAProtected::AOAsetGDTEntry
	mov	DWORD PTR _status$1090[ebp], eax
$L1086:
; Line 103
	xor	eax, eax
; Line 105
...
_DATA	SEGMENT
$SG1183	DB	'aoatask:aoasuspendtask circular list is full', 00H
_DATA	ENDS
_TEXT	SEGMENT
_delayw$ = 8
_statec$ = 12
...
_DATA	SEGMENT
	ORG $+3
$SG1191	DB	'aoatask:aoacompletetask stack is full', 00H
_DATA	ENDS
_TEXT	SEGMENT
_currenttask$ = 8
_this$ = -4
