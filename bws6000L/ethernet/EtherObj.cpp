...
// initialization
//------------------------------------------
int EtherObj::inittest(long tbaseAddress, long tbufferPointer, long rbaseAddress, long rbufferPointer, char *srcmac) 
  {
     int retcode=0;
     int tdtail=0;
     int rdtail=0;
...
int EtherObj::REnable() 
  {
    ...
    //RKK-AW
    retcode = setRCtrl(0x0440800a); //bit3 = 1 prom mode 
...
int EtherObj::HotReset() 
  {
	...
	retcode = inittest(DPD_ADDR, DPD_DATA, UPD_ADDR, UPD_DATA, mac);
	retcode = TEnable();
	retcode = REnable();
